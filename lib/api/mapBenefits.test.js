...
describe('Maps EI', () => {
  ...
  it('Calculates estimatedDecisionDate', () => {
    ...
    const dateTR = newNormalizedDate('2060-05-22').toDateString() //plus 28 days
...
describe('CPP Mappings', () => {
  ...
  it('Calculates next payment for monthly', () => {
    ...
    const dateTR = newNormalizedDate('2023-05-24').toDateString() //plus 1 month
  ...
  it('Calculates lastStatusDate corectly', () => {
    ...
    const dateTR = newNormalizedDate('2060-04-18').toDateString() //plus 14 days for cpp
    const mappedData = MapCPPCard({
      programCode: 32294,
      benefitType: 'Beneficial',
...
describe('CPPD Mappings', () => {
  ...
  it('Calculates lastStatusDate corectly', () => {
    const dateTT = '2060-04-04'
    const dateTR = newNormalizedDate('2060-08-02').toDateString() //plus 120 days for cppd
    const mappedData = MapCPPCard({
      programCode: 32295,
      benefitType: 'Survivor',
      benefitStatus: 'Received',
...
describe('maps OAS', () => {
  ...
  it('Calculates estimatedDecisionDate', () => {
    const dateTT = '2060-04-04'
    const dateTR = newNormalizedDate('2060-04-18').toDateString() //plus 14 days
